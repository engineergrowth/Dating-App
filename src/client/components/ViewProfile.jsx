...
const ViewProfile = () => {
  ...
  if (!profile) {
    return (
      <div className="text-gray-500 text-center p-10 text-xl">
        Profile not found
      </div>
    );
  }
  return (
    <div
      ...
      className="p-5 rounded-lg mx-auto my-8 shadow-md border-4 "
    >
      <div
        className="bg-white p-5 rounded-lg mx-auto my-8 shadow-md border-4 "
        style={{ maxWidth: "900px", maxHeight: "600px" }}
      >
        <div className="flex justify-center items-center min-h-screen">
          <div
            className="flex flex-row items-start space-x-6 mx-auto p-6 bg-white shadow-lg rounded-lg border-4 "
          ...
          >
            ...
            <div className="flex-none" style={{ flexBasis: "50%" }}>
              ...
              <div>
                ...
                <p>
                  <strong>Orientation:</strong> {profile.orientation}
                </p>
                <p>
                  <strong>Body Type:</strong> {profile.body_type}
                </p>
                <p>
                  <strong>Height (ft):</strong> {profile.height_ft}'
                  {profile.height_in}
                </p>
              </div>
              <div>
                ...
                <p>
                  <strong>Age Preference:</strong> {profile.age_preference}
                </p>
              </div>
              <Link
